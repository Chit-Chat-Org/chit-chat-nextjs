...
const HomePage = () => {
  const words = ["Dream", "Better", "Cute", "Beautiful", "Modern"];
        ...
        <Container>
          <div className="flex flex-col items-center justify-center py-20 h-full">
            <button className="group relative grid overflow-hidden rounded-full px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
              ...
              <Link
                href="/dashboard"
                className="z-10 py-0.5 text-sm text-neutral-100 flex items-center justify-center gap-1.5"
              >
                <Image
            ...
            <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
              ...
              <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                Zero code, maximum speed. Make professional chatbot easy, fast
                and fun while delivering best-in-class SEO, performance.
              </p>
              <div className="hidden overflow-hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                <Link
                  href="/dashboard"
                  className="flex items-center justify-center w-max rounded-full border-t border-foreground/30 bg-white/20 backdrop-blur-lg px-2 py-1 md:py-2 gap-2 md:gap-8 shadow-3xl shadow-background/40 cursor-pointer select-none"
                >
                  <p className="text-foreground text-sm text-center md:text-base font-medium pl-4 pr-4 lg:pr-0">
                    ✨ {"  "} Start building your dream chatbot now!
                  </p>
                  <Button
                    size="sm"
        ...
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            ...
            <h2 className="text-3xl lg:text-4xl font-semibold mt-6">
              Three steps to build your dream chatbot
            </h2>
      ...
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        ...
        <Container>
          ...
          >
            ...
            <p className="text-muted-foreground mt-6">
              Chit Chat offers a range of features to help you build a stunning
              chatbot in no time
            </p>
          </div>
        </Container>
      ...
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        ...
        <Container>
          ...
          >
            ...
            <p className="text-muted-foreground mt-6">
              See how Chit Chat empowers businesses of all sizes. Here&apos;s
          ...
          <LampContainer>
            ...
            >
              ...
              <p className="text-muted-foreground mt-6 max-w-md mx-auto">
                Design stunning chatbots effortlessly with Chit Chat&apos;s
                intuitive drag-and-drop config and powerful AI assistant.
              </p>
        ...
        <Container className="relative z-[999999]">
          ...
          <div className="mt-8 border-t border-border/40 pt-4 md:pt-8 md:flex md:items-center md:justify-between w-full">
            <p className="text-sm text-muted-foreground mt-8 md:mt-0">
              &copy; {new Date().getFullYear()} Chit Chat AI INC. All rights
              reserved.
            </p>
          </div>
        </Container>
